...
void register_gpio_interrupt(){
    ...
    // set operating mode of interrupt pin to pull-up (i.e. interrupt is generated if pin is getting grounded)
...
void int_report_demo_task(void *pvParameter){
    ...
    while(1){
        ...
        // print the number of interrupts handled by the interrupt handler handle_gpio_interrupt
